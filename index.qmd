...
bspd_marginalized_proportions_value <- 0.95
bspd_marginalized_proportions_coefficient <- 0.85
```
...
bspd_intersectionally_marginalized_value <- 0.95
bspd_intersectionally_marginalized_coefficient <- 0.85
```
...
bspd_marginalized_proportions_score <- adjust_component_score(
  bspd_marginalized_proportions_value,
  bspd_marginalized_proportions_coefficient
)

bspd_intersectionally_marginalized_score <- adjust_component_score(
  bspd_intersectionally_marginalized_value,
  bspd_intersectionally_marginalized_coefficient
)
...
category_scores <- category_scores |>
  add_category(
    "PD @ BS",
    "Participation",
    bspd_number_of_participants,
    participants_weight,
    bspd_marginalized_proportions_score,
    bspd_intersectionally_marginalized_score
  )
...
category_scores <- category_scores |>
  add_category(
    "PD @ BS",
    "Engagement",
    bspd_engagement_hours,
    engagement_weight,
    bspd_frequency_score,
    bspd_duration_score
  )
...
tg_number_of_infrastructure_products <- 20
bspd_number_of_infrastructure_products <- 20
...
tg_infrastructure_purpose <- 0.95
bspd_infrastructure_purpose <- 0.95
...
bspd_infrastructure_co_construction <- 0.10
...
category_scores <- category_scores |>
  add_category(
    "PD @ BS",
    "Infrastructure",
    bspd_number_of_infrastructure_products,
    infrastructure_weight,
    bspd_infrastructure_purpose,
    bspd_infrastructure_co_construction
  )
...
bspd_distribution_of_venues <- 0.10
...
bspd_inclusion_of_participants <- 0.10
...
category_scores <- category_scores |>
  add_category(
    "PD @ BS",
    "Outputs",
    bspd_number_of_outputs,
    outputs_weight,
    bspd_distribution_of_venues,
    bspd_inclusion_of_participants
  )
...
bspd_distribution_of_responsibility <- 0.5
...
bspd_distribution_of_material_support <- 0.5
...
category_scores <- category_scores |>
  add_category(
    "PD @ BS",
    "Sustainability",
    bspd_number_of_partners,
    sustainability_weight,
    bspd_distribution_of_responsibility,
    bspd_distribution_of_material_support
  )
...
* *Direct Impact:* **65 teachers** participated in the Professional Development
project.
* *1 Degree of Separation:* There are **575 students** enrolled in the school,
...
pdtg_ripple <- data.frame(
  ...
  values = c(65, 575, 2300)
)
```

```{r set-bspd-ripple, echo = TRUE}
bspd_ripple <- data.frame(
  group = c(0, 1, 2),
  group_name = c(
    "Teachers",
    "Students",
...
bspd_ripple <- bspd_ripple |> calculate_ripple()
...
bspd_vogel_frame <- bspd_ripple |> prepare_vogel()
...
bspd_vogel_ripple <- bspd_vogel_frame |> plot_vogel(bspd_ripple$group_name)
...
bspd_composite_ripple_score <- sum(bspd_ripple$ripple_score)
...
bspd_overall_score <- calculate_overall(category_scores, "PD @ BS")
...
bspd_composite_frame <- category_scores |>
  prep_composite("PD @ BS")
...
pdtg_arch_frame <- pdtg_composite_frame |>
  prep_arch()
bspd_arch_frame <- bspd_composite_frame |>
  prep_arch()
...
bspd_composite_arch <- bspd_arch_frame |>
  plot_arch(bspd_composite_frame)
...
bspd_arch_title <- create_title_line("Composite Impact Score", bspd_overall_score)
...
bspd_ripple_title <- create_title_line("Ripple Effect Score", bspd_composite_ripple_score)
...
bspd_composite_indicator_score <- calculate_indicator_score(
  category_scores,
  "PD @ BS",
  indicator_weights
)
...
bspd_indicator_title <- create_title_line("Direct Indicator Score", bspd_composite_indicator_score)
...
bspd_bottom_badge <- construct_bottom_badge(
  bspd_arch_title,
  bspd_ripple_title,
  bspd_composite_arch,
  bspd_vogel_ripple
...
bspd_indicator_frame <- prep_indicators(category_scores, "PD @ BS")
...
bspd_indicator_plot <- plot_indicators(pdtg_indicator_frame)
...
bspd_badge <- construct_badge(
  bspd_indicator_title,
  bspd_indicator_plot,
  bspd_bottom_badge
)
...
ggsave("outputs/pdtg_dashboard.png", pdtg_badge, width = 16, height = 10, units = "in", dpi = 320)
ggsave("outputs/pdtg_dashboard.pdf", pdtg_badge, width = 16, height = 10, units = "in", dpi = 320)
ggsave("outputs/bspd_dashboard.png", bspd_badge, width = 16, height = 10, units = "in", dpi = 320)
ggsave("outputs/bspd_dashboard.pdf", bspd_badge, width = 16, height = 10, units = "in", dpi = 320)
ggsave("outputs/fafi_dashboard.png", fafi_badge, width = 16, height = 10, units = "in", dpi = 320)
ggsave("outputs/fafi_dashboard.pdf", fafi_badge, width = 16, height = 10, units = "in", dpi = 320)
ggsave("outputs/stst_dashboard.png", stst_badge, width = 16, height = 10, units = "in", dpi = 320)
ggsave("outputs/stst_dashboard.pdf", stst_badge, width = 16, height = 10, units = "in", dpi = 320)
```
...
:::{.column-page-inset}
![](outputs/pdtg_dashboard.png)
:::

:::{.column-page-inset}
![](outputs/bspd_dashboard.png)
:::
