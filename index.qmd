...
$$
S_C = I_C \cdot \left(1 + \frac{\sum r_{C_1} \ldots r_{C_n}}{|R_C|}\right)
$$
...
summation of all the category scores:
...
$$
p_s = p_n \cdot \left( 1 + \frac{(\beta_m \cdot p_m + \beta_i \cdot p_i)}{2} \right)
$$
...
$$
e_s = e_h \cdot \left(1 + \frac{(e_d + e_f)}{2}\right)
$$
...
$$
i_s = i_p \cdot \left(1 + \frac{(i_u + i_c)}{2}\right)
$$
...
$$
s_o = i_o \cdot \left(1 + \frac{(o_v + o_i)}{2}\right)
$$
...
$$
s_s = i_s \cdot \left(1 + \frac{(c_{s_r} + c_{s_m})}{2}\right)
$$
