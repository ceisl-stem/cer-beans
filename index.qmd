...
calculate_indicator_score <- function(the_frame, the_project) {
...
$$
S_C = \beta_CI_C \left(1 + \frac{\sum r_{C_1} \ldots r_{C_n}}{|R_C|}\right)
$$
...
pdtg_composite_indicator_score <- calculate_indicator_score(category_scores, "PD @ TG")
fafi_composite_indicator_score <- calculate_indicator_score(category_scores, "FAFI")
